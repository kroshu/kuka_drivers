...
typedef struct _MessageCommandData {
    ...
    QuaternionTransformation commandedTransformations[5];
    size_t writeIORequest_count;
    FriIOValue writeIORequest[10];
    bool has_cartesianPose;
    QuaternionTransformation cartesianPose;
...
typedef struct _MessageMonitorData {
    ...
    QuaternionTransformation measuredCartesianPose;
    bool has_measuredRedundancyInformation;
    RedundancyInformation measuredRedundancyInformation;
    bool has_timestamp;
    TimeStamp timestamp;
} MessageMonitorData;
...
typedef struct _FRIMonitoringMessage {
    ...
    QuaternionTransformation requestedTransformations[5];
    bool has_endOfMessageData;
    MessageEndOf endOfMessageData;
...
extern const pb_field_t QuaternionTransformation_fields[4];
extern const pb_field_t FriIOValue_fields[6];
extern const pb_field_t RedundancyInformation_fields[3];
...
extern const pb_field_t MessageIpoData_fields[7];
extern const pb_field_t MessageCommandData_fields[8];
...
#define RedundancyInformation_size               15
