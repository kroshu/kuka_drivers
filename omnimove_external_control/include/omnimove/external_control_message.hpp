...
namespace omnimove{
    ...
    private:
        std::unique_ptr<char[]> getMessageData(int speed_x, int speed_w, int pillar1_pos, int pillar2_pos, int pillar3_pos, int pillar4_pos, int shield_pos);
    public:
        ExternalControlCaterpillarDriveCommand(int speed_x, int speed_w, int pillar1_pos, int pillar2_pos, int pillar3_pos, int pillar4_pos, int shield_pos);
    };
