...
#include "kuka_rsi_driver/robot_status_manager_mxa.hpp"
...
{
class KukaMxaRsiHardwareInterface : public hardware_interface::SystemInterface
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(KukaMxaRsiHardwareInterface)

  KUKA_RSI_DRIVER_PUBLIC KukaMxaRsiHardwareInterface()
  : SystemInterface(), logger_(rclcpp::get_logger("KukaMxaRsiHardwareInterface"))
  {
  }
