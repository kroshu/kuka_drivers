...
#ifndef KUKA_IIQKA_DRIVERS_CORE__ROBOT_MANAGER_NODE_HPP_
#define KUKA_IIQKA_DRIVERS_CORE__ROBOT_MANAGER_NODE_HPP_
...
namespace kuka_eac
{
class RobotManagerNodeBase : public kuka_drivers_core::ROS2BaseLCNode
{
public:
  RobotManagerNodeBase();
...
#endif  // KUKA_IIQKA_DRIVERS_CORE__ROBOT_MANAGER_NODE_HPP_
