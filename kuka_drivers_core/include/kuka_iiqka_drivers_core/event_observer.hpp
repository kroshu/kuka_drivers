...
#ifndef KUKA_IIQKA_DRIVERS_CORE__EVENT_OBSERVER_HPP_
#define KUKA_IIQKA_DRIVERS_CORE__EVENT_OBSERVER_HPP_
...
{
public:
  explicit KukaEACEventObserver(KukaEACHardwareInterfaceBase * hw_interface)
  ...
  void OnSampling() override
  {
    ...
    RCLCPP_INFO(rclcpp::get_logger("KukaEACHardwareInterfaceBase"), "External control is active");
  }
  void OnControlModeSwitch(const std::string &) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger("KukaEACHardwareInterfaceBase"), "Control mode switch is in progress");
  ...
  void OnStopped(const std::string &) override
  {
    ...
    RCLCPP_INFO(rclcpp::get_logger("KukaEACHardwareInterfaceBase"), "External control finished");
  ...
  void OnError(const std::string & reason) override
  {
    ...
    RCLCPP_ERROR(
      rclcpp::get_logger("KukaEACHardwareInterfaceBase"), "External control stopped by an error");
    RCLCPP_ERROR(rclcpp::get_logger("KukaEACHardwareInterfaceBase"), reason.c_str());
    hw_interface_->set_stop_flag();
  }

private:
  KukaEACHardwareInterfaceBase * hw_interface_;
};

}  // namespace kuka_eac

#endif  // KUKA_IIQKA_DRIVERS_CORE__EVENT_OBSERVER_HPP_
