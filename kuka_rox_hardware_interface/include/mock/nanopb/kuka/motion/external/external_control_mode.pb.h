...
#define _kuka_motion_external_ExternalControlMode_MIN kuka_motion_external_ExternalControlMode_EXTERNAL_CONTROL_MODE_UNSPECIFIED
#define _kuka_motion_external_ExternalControlMode_MAX kuka_motion_external_ExternalControlMode_TORQUE_CONTROL
#define _kuka_motion_external_ExternalControlMode_ARRAYSIZE ((kuka_motion_external_ExternalControlMode)(kuka_motion_external_ExternalControlMode_TORQUE_CONTROL+1))
