...
#include <pb.h>
#include <nanopb/google/protobuf/any.pb.h>
...
#define _kuka_motion_external_ExternalControlMode_MAX \
  kuka_motion_external_ExternalControlMode_TORQUE_CONTROL
#define _kuka_motion_external_ExternalControlMode_ARRAYSIZE (( \
    kuka_motion_external_ExternalControlMode)( \
    kuka_motion_external_ExternalControlMode_TORQUE_CONTROL + 1))
