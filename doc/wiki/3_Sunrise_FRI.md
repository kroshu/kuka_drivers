...
2. To start the driver, two launch file are available, with and without `rviz`. To launch (without `rviz`), run
    ...
    - [`fri_configuration_controller`](4_Controllers.md#32-fri_configuration_controller) (no configuration file)
    - [`fri_state_broadcaster`](4_Controllers.md#21-fri_state_broadcaster) (no configuration file)
    ...
    - [`control_mode_handler`](4_Controllers.md#31-kuka_control_mode_handler) (no configuration file)
